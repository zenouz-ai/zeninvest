...
Intraday mode also runs a dedicated refresh lane: Mon–Fri `09:50`, `10:10`, `12:20`, `12:40`, `15:05`, `15:25` America/New_York, plus Sat/Sun `17:00` America/New_York. These refresh runs sync broker order truth, write a fresh `portfolio_snapshots` row, warm held/pending/queued market data, and run deterministic stop/profit-lock maintenance without screening new names. Other scheduled jobs remain: daily snapshot 21:30 UTC, weekly report Fri 22:00 UTC, instrument refresh Sun 12:00 UTC, strategy episode scan daily 02:00 UTC (auto-publishes confirmed attribution episodes from recent git history).
