...
└── frontend/              # React + Vite + Tailwind frontend
    └── src/
        ├── pages/         # 9 pages: Dashboard, Universe, Portfolio, Opportunity, OrderManagement, RunHistory, WorldNews, Costs, Roadmap
