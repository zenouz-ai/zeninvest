...
- `GET /api/public/universe`, `GET /api/public/portfolio`, `GET /api/public/portfolio/history`, `GET /api/public/runs`, `GET /api/public/opportunity` — Public sanitized demo feeds for anonymous dashboard pages
