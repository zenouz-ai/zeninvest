...
export const MILESTONES: Milestone[] = [
  ...
  },
  {
    ...
    horizon: 'Soon',
    timeboxDays: 2,
    description: 'Point-in-time guidance snapshots from macro, micro, and outcome data that tilt screening and enrich committee context, with explicit per-cycle influence audit.',
    architectureComponents: ['Data Fetcher', 'Universe Screener', 'Strategy Engine', 'Dashboard'],
  ...
  },
  {
    ...
    horizon: 'Soon',
    timeboxDays: 2,
    description: 'Git-backed, human-reviewed strategy-change episodes mapped onto cycle/version fingerprints so repo changes can be compared against later outcomes.',
    architectureComponents: ['Dashboard', 'Git', 'Orchestrator', 'Reporting'],
    track: 'Learning Loop & Attribution',
    legacyIds: ['US-2.5', 'US-2.6'],
    materiality: 'useful',
