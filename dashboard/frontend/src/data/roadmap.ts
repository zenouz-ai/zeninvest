...
export const MILESTONES: Milestone[] = [
  ...
  },
  {
    ...
    horizon: 'Next',
    timeboxDays: 2,
    description: 'Repo implementation is landed: nginx ingress, internal-only dashboard service, and updated runbooks. Remaining work is live Cloudflare/VPS verification of the canonical HTTPS path.',
    ...
    materiality: 'crucial',
    activeOrder: 1,
    successCriteria: 'Repo ingress changes are landed and the live domain verifies no public raw :8000, canonical HTTPS access, and proxy-safe operator auth.',
  },
  {
    id: 'US-7.5',
