...
describe('timeline section grouping', () => {
  ...
  it('keeps pipeline milestones in their configured horizon buckets', () => {
    ...
    expect(mlAdvanced?.columns.Pipeline.map((milestone) => milestone.id)).toContain('US-6.4')
  ...
  it('preserves roadmap counts after the reshape', () => {
    ...
    expect(DELIVERED_COUNT).toBe(54)
    expect(PIPELINE_COUNT).toBe(24)
    expect(TOTAL_COUNT).toBe(78)
    expect(PROGRESS_PCT).toBe(69)
